...
LOGIN_SENT_REDIRECT = getattr(settings, 'DESCOPE_LOGIN_SENT_REDIRECT', 'django_descope:login_sent')
LOGIN_TEMPLATE_NAME = getattr(settings, 'DESCOPE_LOGIN_TEMPLATE_NAME', 'django_descope/login.html')
